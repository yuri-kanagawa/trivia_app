...
class TriviaDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String youtube_url_scheme =
        "${ConstText.YouTube_Movie_URLScheme}${videoId}";
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              Share.share(
                  "雑学アプリ TRIVIA ■iOS:${ConstText.iOS_URL} ■Android:${ConstText.Android_URL} ■WEB:${ConstText.Web}");
            },
          ),
        ],
        leading: IconButton(
                  ...
                  children: [
                    ButtonTheme(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          _launchURL("${ConstText.YouTubech_URLScheme}",
                              "${ConstText.YouTubech_URL}");
                        },
