...
class TriviaDetailView extends StatelessWidget {
  ...
  const TriviaDetailView({Key key, this.Bloc, this.trivia , this.flg , this.id ,
    this.title ,this.youtube, this.content1, this.content2, this.content3,this.genre}) : super(key: key);
